...
|                                      **Logistic Regression 모델링<br/>EDA 수행<br/>회의록 및 README 작성**                                      |                                                                    **데이터 수집<br/>EDA 수행<br/>Streamlit 대시보드 구현**                                                                    |                                           **데이터 수집 및 전처리<br/>PPT 작성<br/>기획 및 발표<br/>EDA 수행**                                            |                                        **GitHub 총괄 관리<br/>Random Forest, XGBoost<br/>EDA 수행**                                         |                                 **Streamlit 구현 및 UI 디자인(Figma)<br/>EDA 수행<br/>README 작성<br/>노션정리**                                 |                                                                **데이터 수집 및 전처리<br/>feature 생성<br/>train 및 predict 파이프라인 구축 및 모듈화**                                                                 |
